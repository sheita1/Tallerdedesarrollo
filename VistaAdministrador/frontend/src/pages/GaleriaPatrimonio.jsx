...
function GaleriaPatrimonio({ patrimonioId }) {
  ...
  // ⚠️ CONFIGURACIÓN: URL del Backend
    ...
    <div className="galeria-container">
        ...
        <div className="galeria-grid">
          {imagenes.map((img) => (
            <div key={img.id} className="galeria-item">
              {/* 🔧 CORRECCIÓN CRÍTICA: Agregamos /uploads/ a la ruta */}
              <img
                src={`${URL_BACKEND}/uploads/${img.fileName}`}
                alt={`Imagen ${img.id}`}
      ...
      {imagenAmpliada && (
        <div className="galeria-overlay" onClick={() => setImagenAmpliada(null)}>
          <img
            src={`${URL_BACKEND}/uploads/${imagenAmpliada.fileName}`}
            alt="Imagen ampliada"
